...
import org.example.TicketManager.TicketFlightTimeComparator;
...
public class TicketManagerTest {
    ...
    Ticket ticket6 = new Ticket(6, 17000, "DME", "UFA", 270);
    ...
    Ticket ticket10 = new Ticket(10, 12000, "DME", "UFA", 130);
    ...
    @Test
    public void shouldFindByAirportSortByFlightTime(){
        ...
        TicketFlightTimeComparator comparator = new TicketFlightTimeComparator();


        manager.searchBy("DME", "UFA", comparator);


        Ticket [] expected = {ticket10, ticket5, ticket8, ticket6, ticket1};
        Ticket [] actual = manager.searchBy("DME", "UFA", comparator);
